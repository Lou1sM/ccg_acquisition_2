...
#foreach i (1 3 5 7)
set trans_cats = `ls ${dir}/*reps1*.trans_cats | tr '\n' ':'`
python /Users/ida/Desktop/RA/langacq/result_analysis/draw_syn_cats_graph.py ${trans_cats} ${output_dir}/trans_reps${i}_syn_6way.png #"Learned Prior for Transitive Verbs"
